...
# Credit to https://github.com/noelmiller/isengard/blob/main/scripts/install_1password.sh
...
GID_ONEPASSWORD=$(getent group onepassword | cut -d: -f3)
GID_ONEPASSWORDCLI=$(getent group onepassword-cli | cut -d: -f3)
